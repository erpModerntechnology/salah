        ...
        for employee in employees:
            ...
            for i in range(delta.days + 1):
                ...
                if 8 >= work_hours_sum >= 6:
                    less_than7 = True
                if 10 >= work_hours_sum >= 8.1:
                    less_than10 = True
                if 5.1 >= work_hours_sum >= 3.5:
                    less_than5 = True
                if 2 >= work_hours_sum >= 0:
                    less_than2 = True
    ...
    def print_absent_report(self):
        ...
        for employee in employees:
            ...
            for i in range(delta.days + 1):
                ...
                attendances_check_out = self.env["hr.attendance"].search(
                    [('employee_id', '=', employee.id), ('checkout_date', '=', day.date())
                     ])
                if not attendances_check_out  and not attendances:
                    absent+=1
                # work_hours_sum=0
                # less_than7=False
                # less_than5=False
